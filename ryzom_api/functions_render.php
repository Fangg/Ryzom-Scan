...
function ryzom_render_header_www() {
	return '
		<style type="text/css">
			...
			#main{width:322px;height:300px;margin-left:auto;margin-right:auto;text-align:left}
...
function ryzom_render_www($content) {
	return '
		<div id="main">
			<a href="?language=en&ckey='.$_GET[ckey].'"><img hspace="5" border="0" src="http://www.ryzom.com/data/en_v6.jpg" alt="English" /></a>
			<a href="?language=fr&ckey='.$_GET[ckey].'"><img hspace="5" border="0" src="http://www.ryzom.com/data/fr_v6.jpg" alt="Français" /></a>
			<a href="?language=de&ckey='.$_GET[ckey].'"><img hspace="5" border="0" src="http://www.ryzom.com/data/de_v6.jpg" alt="Deutsch" /></a>
			'.$content.'
		</div>
	';
}
